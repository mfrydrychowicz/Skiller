import {
    Box, Button, ButtonGroup, Divider, Drawer,
    DrawerBody,
    DrawerCloseButton,
    DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, Flex, Input, Spinner, useDisclosure
...
const RoomsList = () => {
    ...
    return (
        <>
            ...
            <Button leftIcon={<AddIcon/>} sx={{position: 'absolute', bottom: '25px', right: '35px', zIndex: '10'}}
                    onClick={onOpen}> Add New Room</Button>
            <Drawer
                isOpen={isOpen}
                placement="right"
                onClose={onClose}
