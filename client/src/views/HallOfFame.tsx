...
export const HallOfFame = () => {
    ...
    const sortingDirectionIcon =
        sortingDirection === sortDirection.DESC ? <StatArrow type="decrease" /> : <StatArrow type="increase" />;
        ...
        <>
            <Modal isOpen={true} onClose={onClose} isCentered>
                ...
                <ModalContent>
                            ...
                            <Thead>
                                <Tr>
                                    ...
                                    <Th onClick={sortByUsername}>
                                        Username
                                        {displayConditionalArrow('username')}
                                    </Th>
                                    <Th>Badges</Th>
                                    <Th isNumeric onClick={sortByPoints}>
                                        Points{displayConditionalArrow('points')}
                                    </Th>
                                </Tr>
                            </Thead>
                            <Tbody>
                    ...
                    <ModalFooter>
                        <Button color="brand.orange" mr={3} onClick={onClose}>
                            Close
                        </Button>
                    </ModalFooter>
                </ModalContent>
